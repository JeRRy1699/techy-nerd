<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="main.admin" %>
...
<div id="wrapper">
  <div id="title">
    <h1>Online Medication<span style="color: #008000;"> Admin</span> Page</h1>
  </div>
  ...
  <div class="container">
    <ul id="navCircle">
      ...
      <li><a href="donated.aspx">Donations</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <asp:Button ID="Button1" runat="server" BorderColor="Black" ForeColor="Green" OnClick="Button1_Click" Text="Logout" />
&nbsp; </li>
    </ul>
  </div>
  <div id="content">
    ...
    <h1>&nbsp;</h1>
      <h1 style="margin-left: 40px">Welcome To Online </h1>
      <h1 style="margin-left: 40px">Medication System</h1>
