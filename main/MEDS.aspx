<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MEDS.aspx.cs" Inherits="main.MEDS" %>
...
<div id="wrapper">
  ...
  <div class="container">
    <ul id="navCircle">
      ...
      <li><a class="active" href="MEDS.aspx">Requests</a></li>
      <li><a href="donated.aspx">Donations</a></li>
    </ul>
  </div>
  <div id="content">
...
<form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="500px" AutoGenerateColumns="false" >
            <Columns>
                <asp:BoundField DataField="name" HeaderText="Medicine Name" />
                <asp:BoundField DataField="type" HeaderText="Medicine Type" />
                <asp:BoundField DataField="quan" HeaderText="Medicine Quantity" />
                <asp:BoundField DataField="num" HeaderText="Mobile Number" />
